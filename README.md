...
После подготовки и очистки данных был собран финальный сбалансированный датасет, включающий как позитивные (с логотипом), так и негативные (без логотипа) примеры. На этом наборе данных проводилось обучение детектора.
